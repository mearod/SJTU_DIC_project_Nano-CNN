/*
    ...
    Filename:      S018V3EBCDSP_X8Y4D72_PR.v
    ...
    Configuration: -instname S018V3EBCDSP_X8Y4D72_PR -rows 8 -bits 72 -mux 4 
    Redundancy: Off
    Bit-Write: Off
*/
...
module S018V3EBCDSP_X8Y4D72_PR(
                          Q,
			  CLK,
			  CEN,
			  WEN,
  ...
  specify
    ...
    $period(posedge CLK,3.414,CLK_CYC_flag);
    $width(posedge CLK,1.024,0,CLK_H_flag);
    $width(negedge CLK,1.024,0,CLK_L_flag);
