/*
    ...
    Filename:      S018V3EBCDSP_X8Y4D16_PR.v
    ...
    Configuration: -instname S018V3EBCDSP_X8Y4D16_PR -rows 8 -bits 16 -mux 4 
    Redundancy: Off
    Bit-Write: Off
*/
...
module S018V3EBCDSP_X8Y4D16_PR(
                          Q,
			  CLK,
			  CEN,
			  WEN,
  ...
  //   $period(posedge CLK,3.234,CLK_CYC_flag);
  //   $width(posedge CLK,0.970,0,CLK_H_flag);
  //   $width(negedge CLK,0.970,0,CLK_L_flag);
