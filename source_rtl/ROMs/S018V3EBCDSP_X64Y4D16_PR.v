/*
    ...
    Filename:      S018V3EBCDSP_X64Y4D16_PR.v
    ...
    Configuration: -instname S018V3EBCDSP_X64Y4D16_PR -rows 64 -bits 16 -mux 4 
    Redundancy: Off
    Bit-Write: Off
*/
...
module S018V3EBCDSP_X64Y4D16_PR(
                          Q,
			  CLK,
			  CEN,
			  WEN,
  ...
  //   $period(posedge CLK,3.275,CLK_CYC_flag);
  //   $width(posedge CLK,0.983,0,CLK_H_flag);
  //   $width(negedge CLK,0.983,0,CLK_L_flag);
