/*
    ...
    Filename:      S018V3EBCDSP_X8Y4D77_PR.v
    ...
    Configuration: -instname S018V3EBCDSP_X8Y4D77_PR -rows 8 -bits 77 -mux 4 
    Redundancy: Off
    Bit-Write: Off
*/
...
module S018V3EBCDSP_X8Y4D77_PR(
                          Q,
			  CLK,
			  CEN,
			  WEN,
  ...
  specify
    ...
    $period(posedge CLK,3.431,CLK_CYC_flag);
    $width(posedge CLK,1.029,0,CLK_H_flag);
    $width(negedge CLK,1.029,0,CLK_L_flag);
