/*
    ...
    Filename:      S018V3EBCDSP_X64Y4D32_PR.v
    ...
    Configuration: -instname S018V3EBCDSP_X64Y4D32_PR -rows 64 -bits 32 -mux 4 
    Redundancy: Off
    Bit-Write: Off
*/
...
module S018V3EBCDSP_X64Y4D32_PR(
                          Q,
			  CLK,
			  CEN,
			  WEN,
  ...
  //   $period(posedge CLK,3.325,CLK_CYC_flag);
  //   $width(posedge CLK,0.997,0,CLK_H_flag);
  //   $width(negedge CLK,0.997,0,CLK_L_flag);
